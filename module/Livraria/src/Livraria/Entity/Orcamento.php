...
class Orcamento extends AbstractSeguro {
   ...
   /**
     ...
     * @var float $incendio
     *
     * @ORM\Column(name="incendio", type="decimal", precision=20, scale=6, nullable=true)
     */
    protected $incendio;
     ...
     * @var float $comissao
     *
     * @ORM\Column(name="comissao", type="decimal", precision=10, scale=6, nullable=true)
     */
    protected $comissao;
     ...
     * @var float $taxaIof
     *
     * @ORM\Column(name="taxa_iof", type="decimal", precision=10, scale=6, nullable=false)
     */
    protected $taxaIof;
