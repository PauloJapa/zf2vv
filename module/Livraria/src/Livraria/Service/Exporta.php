...
class Exporta extends AbstractService{
    ...
    public function prepArqsForMaritima($admCod, $returnArray=false){
        ...
        $file['e0530.00'] = $this->baseWork . $admCod . '_empresarial_1x4_30.KM2';
        ...
        $file['e0569.99'] = $this->baseWork . $admCod . '_empresarial_1x4_69.KM2';
        ...
        $file['r0530.00'] = $this->baseWork . $admCod . '_residencial_1x4_30.KM2';
        ...
        $file['r0569.99'] = $this->baseWork . $admCod . '_residencial_1x4_69.KM2';
