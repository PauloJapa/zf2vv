...
<script language="javascript">
    ...
    var resetFieldsOfApartamento = function(){  
        ...
        $fieldTaxa.append($fieldApto.find('#popcomEleRen').remove());
        $fieldTaxa.append($fieldApto.find('#popsemEleRen').remove());
        $fieldApto.hide();
    ...
    var resetFieldsOfCasa = function(){   
        ...
        $fieldTaxa.append($fieldCasa.find('#popcomEleRen').remove());
        $fieldTaxa.append($fieldCasa.find('#popsemEleRen').remove());
        $fieldCasa.hide();
    ...
    var setFieldsOfApartamento = function(){  
        ...
        $fieldApto.find('#celApt2').append($fieldTaxa.find('#popcomEleRen').remove());
        $fieldApto.find('#celApt2').append($fieldTaxa.find('#popsemEleRen').remove());
        $fieldApto.show();
    ...
    var setFieldsOfCasa = function(){ 
        ...
        $fieldCasa.find('#celCasa2').append($fieldTaxa.find('#popcomEleRen').remove());
        $fieldCasa.find('#celCasa2').append($fieldTaxa.find('#popsemEleRen').remove());    
        $fieldCasa.show();
